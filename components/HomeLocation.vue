  ...
  <v-container class="pa-0" :fluid="true">
    <v-row>
      <v-col cols="12" class="text-center">
        <span style="font-weight: 900; font-size: 4rem" class="color-third"
          >¿COMO LLEGAR?</span
        >
      </v-col>
    </v-row>
    <v-row>
      ...
      <v-col cols="7" class="d-flex flex-column align-center text-center">
        <h1 style="font-weight: 800; font-size: 4rem" class="color-main">
          TRANSPORTE PÚBLICO
        </h1>
        <span style="font-weight: 400; font-size: 1.3rem"
          >Horarios de Flota Aguila</span
        >
        <span style="font-weight: 400; font-size: 1.3rem">
          Buses directos para Nimaima desde Portal de la 80:
        </span>
        <span style="font-weight: 400; font-size: 1.3rem">5:10 am</span>
        <span style="font-weight: 400; font-size: 1.3rem">8:50 am</span>
        <span style="font-weight: 400; font-size: 1.3rem">4:10 pm</span>
        <h2 style="font-weight: 800; font-size: 4rem" class="color-main">
          ¡TE ESPERAMOS!
        </h2>
      </v-col>
    </v-row>
